...
public void OnPluginStart() {
	RegConsoleCmd("sm_spec", cmdSpec, "sm_spec <target> - Spectates a player.", COMMAND_FILTER_NO_IMMUNITY);
	RegAdminCmd("sm_fspec", cmdForceSpec, ADMFLAG_GENERIC, "sm_spec <target> <targetToSpec>.");
...
void menuSpec(int client) {
	Menu menu = new Menu(menuHandler_Spec, MENU_ACTIONS_DEFAULT|MenuAction_DrawItem);
